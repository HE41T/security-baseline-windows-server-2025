# ==============================================================
# CIS Check: 2.2.33 (L1) - Audit Script
# Description: Impersonate a client after authentication
# ==============================================================

$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = "*S-1-5-32-544,*S-1-5-19,*S-1-5-20,*S-1-5-6,*S-1-5-32-568"
...
try {
    ...
    if ([string]::IsNullOrWhiteSpace($CurrentSetting)) {
        ...
        Write-Host "Value found. Please verify against: *S-1-5-32-544,*S-1-5-19,*S-1-5-20,*S-1-5-6,*S-1-5-32-568" -ForegroundColor Cyan
