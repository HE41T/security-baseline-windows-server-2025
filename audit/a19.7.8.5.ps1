...
# Verification: Export USER_RIGHTS via secedit and look for the pattern: Turn off Spotlight collection on
# ==============================================================
...
Write-Host "Control 19.7.8.5: Verify Spotlight collection on Desktop is disabled"
Write-Host "=============================================================="
