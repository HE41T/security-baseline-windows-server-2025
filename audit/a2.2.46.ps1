# ==============================================================
# CIS Check: 2.2.46 (L1) - Audit Script
...
Write-Host "Control 2.2.46: Restore files and directories"
Write-Host "=============================================================="
...
try {
    ...
    if ([string]::IsNullOrWhiteSpace($CurrentSetting)) {
        ...
        Write-Host "Value found. Please verify against: *S-1-5-32-544" -ForegroundColor Cyan
