# ==============================================================
# CIS Check: 2.2.22 (L1) - Audit Script
# Description: Deny access to this computer from the network
# ==============================================================

$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = "*S-1-5-32-546,*S-1-5-113"
...
try {
    ...
    if ([string]::IsNullOrWhiteSpace($CurrentSetting)) {
        ...
        Write-Host "Value found. Please verify against: *S-1-5-32-546,*S-1-5-113" -ForegroundColor Cyan
