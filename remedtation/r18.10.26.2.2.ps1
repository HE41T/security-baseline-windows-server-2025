# ==============================================================
# CIS Check: 18.10.26.2.2 (L1) - Remediation Script
...
$LogFile = "C:\Windows\Temp\remediate_security_eventlog_maxsize.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.26.2.2: Ensure 'Security Log MaxSize' is >= $DesiredValue KB"
Write-Host "=============================================================="
