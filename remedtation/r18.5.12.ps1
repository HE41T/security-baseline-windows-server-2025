# ==============================================================
# CIS Check: 18.5.12 (L1) - Remediation Script
# Description: Ensure 18.5.12 WarningLevel is set to 90
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.5.12.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.5.12: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
