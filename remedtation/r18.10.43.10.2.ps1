# ==============================================================
# CIS Check: 18.10.43.10.2 (L1) - Remediation Script
...
$LogFile = "C:\Windows\Temp\remediate_18_10_43_10_2.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.43.10.2: Ensure 'Scan all downloaded files and attachments' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
