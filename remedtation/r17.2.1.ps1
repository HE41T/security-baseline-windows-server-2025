# ==============================================================
# CIS Check: 17.2.1 (L1) - Remediation Script
# Description: Audit Application Group Management
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_17_2_1.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 17.2.1: Audit Application Group Management"
Write-Host "=============================================================="
...
$Subcat = "Application Group Management"
try {
