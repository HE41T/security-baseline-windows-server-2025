# ==============================================================
# CIS Check: 2.3.9.5 (L1) - Remediation Script
# Description: Ensure 'Microsoft network server: Server SPN target name validation level' is set to 'Accept if provided by client' or higher (MS only) (Automated)
# ==============================================================
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 2.3.9.5: Server SPN target name validation level"
Write-Host "=============================================================="
