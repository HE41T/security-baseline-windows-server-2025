# ==============================================================
# CIS Check: 18.6.4.2 (L1) - Remediation Script
# Description: Ensure 18.6.4.2 EnableNetbios is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.4.2.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.4.2: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
