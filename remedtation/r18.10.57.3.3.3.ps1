# ==============================================================
# CIS Check: 18.10.57.3.3.3 (L1) - Remediation Script
# Description: Set 'Do not allow drive redirection' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_rdp_drive_redirection.log"
...
Write-Host "Disabling RDP drive redirection (Registry: 1)"
Write-Host "=============================================================="
