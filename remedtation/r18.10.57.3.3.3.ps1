...
$LogFile = "C:\Windows\Temp\remediate_18_10_57_3_3_3.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.57.3.3.3: Ensure 'Do not allow drive redirection' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
