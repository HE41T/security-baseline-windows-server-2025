# ==============================================================
# CIS Check: 18.5.8 (L1) - Remediation Script
# Description: Ensure 18.5.8 SafeDllSearchMode is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.5.8.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.5.8: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
