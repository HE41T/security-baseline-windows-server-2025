# ==============================================================
# CIS Check: 18.5.6 (L1) - Remediation Script
# Description: Ensure 18.5.6 NoNameReleaseOnDemand is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.5.6.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.5.6: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
