...
# Description: Set 'Allow indexing of encrypted files' to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_search_indexing.log"
...
Write-Host "Disabling indexing of encrypted files (Registry: 0)"
Write-Host "=============================================================="
