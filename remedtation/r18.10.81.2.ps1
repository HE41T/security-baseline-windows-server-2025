# ==============================================================
# CIS Check: 18.10.81.2 (L1) - Remediation Script
# Description: Set 'Always install with elevated privileges' to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_msi_elevation.log"
...
Write-Host "Disabling 'Always install with elevated privileges' (Registry: 0)"
Write-Host "=============================================================="
