# ==============================================================
# CIS Check: 18.9.24.1 (L1) - Remediation Script
# Description: Ensure 18.9.24.1 DeviceEnumerationPolicy is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.24.1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.24.1: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
