...
# Description: Set 'Prevent the usage of OneDrive for file storage' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_onedrive_restriction.log"
...
Write-Host "Disabling OneDrive usage for file storage (Registry: 1)"
Write-Host "=============================================================="
