...
# Description: Set 'Scan excluded files and directories during quick scans' to 'Enabled: 1'
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_quickscan_exclusions.log"
...
Write-Host "Setting Quick Scan to include exclusions (Enabled: 1)"
Write-Host "=============================================================="
