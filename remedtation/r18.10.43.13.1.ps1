# ==============================================================
# CIS Check: 18.10.43.13.1 (L1) - Remediation Script
# Description: Ensure 'Scan excluded files and directories during quick scans' is set to 'Enabled: 1' (Automated)
# Registry Path: HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Scan
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18_10_43_13_1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.43.13.1: Ensure 'Scan excluded files and directories during quick scans' is set to 'Enabled: 1' (Automated)"
Write-Host "=============================================================="
