# ==============================================================
# CIS Check: 18.10.57.3.9.2 (L1) - Remediation Script
# Description: Set 'Require secure RPC communication' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_rdp_secure_rpc.log"
...
Write-Host "Enforcing Secure RPC communication (Registry: 1)"
Write-Host "=============================================================="
