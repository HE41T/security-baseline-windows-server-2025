...
$LogFile = "C:\Windows\Temp\remediate_18_10_57_3_9_2.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.57.3.9.2: Ensure 'Require secure RPC communication' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
