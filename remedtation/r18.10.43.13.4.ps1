...
# Description: Set 'Trigger a quick scan after X days without any scans' to 'Enabled: 7'
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_aggressive_scan_catchup.log"
...
Write-Host "Setting Aggressive Quick Scan Catchup to 7 Days"
Write-Host "=============================================================="
