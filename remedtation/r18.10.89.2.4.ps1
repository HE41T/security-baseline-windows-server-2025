...
$LogFile = "C:\Windows\Temp\remediate_18_10_89_2_4.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.89.2.4: Ensure 'Disallow WinRM from storing RunAs credentials' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
