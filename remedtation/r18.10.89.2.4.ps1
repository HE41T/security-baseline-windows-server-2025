# ==============================================================
# CIS Check: 18.10.89.2.4 (L1) - Remediation Script
# Description: Set 'Disallow WinRM from storing RunAs credentials' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_winrm_runas.log"
...
Write-Host "Disabling WinRM RunAs Credential Storage (Registry: 1)"
Write-Host "=============================================================="
