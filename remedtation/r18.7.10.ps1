# ==============================================================
# CIS Check: 18.7.10 (L1) - Remediation Script
# Description: Ensure 18.7.10 RestrictDriverInstallationToAdministrators is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.7.10.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.7.10: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
