...
$LogFile = "C:\Windows\Temp\remediate_18_10_57_2_2.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.57.2.2: Ensure 'Do not allow passwords to be saved' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
