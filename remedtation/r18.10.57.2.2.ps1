# ==============================================================
# CIS Check: 18.10.57.2.2 (L1) - Remediation Script
# Description: Set 'Do not allow passwords to be saved' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_rdp_password_restriction.log"
...
Write-Host "Disabling RDP password saving (Registry: 1)"
Write-Host "=============================================================="
