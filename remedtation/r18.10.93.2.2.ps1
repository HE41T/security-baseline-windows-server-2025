# ==============================================================
# CIS Check: 18.10.93.2.2 (L1) - Remediation Script
# Description: Set 'Scheduled install day' to '0 - Every day'
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_wu_scheduled_day.log"
...
Write-Host "Setting update schedule to Every Day (Registry: 0)"
Write-Host "=============================================================="
