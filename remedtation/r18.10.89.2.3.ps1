# ==============================================================
# CIS Check: 18.10.89.2.3 (L1) - Remediation Script
# Description: Set 'Allow unencrypted traffic' for WinRM Service to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_winrm_service_encryption.log"
...
Write-Host "Disabling WinRM Service Unencrypted Traffic (Registry: 0)"
Write-Host "=============================================================="
