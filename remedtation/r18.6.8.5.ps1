# ==============================================================
# CIS Check: 18.6.8.5 (L1) - Remediation Script
# Description: Ensure 18.6.8.5 EnableMailslots is set to 0
# ==============================================================

$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 0
$RegPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\NetworkProvider"
$RegName = "EnableMailslots"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.8.5: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
