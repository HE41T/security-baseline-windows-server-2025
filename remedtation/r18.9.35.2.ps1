# ==============================================================
# CIS Check: 18.9.35.2 (L1) - Remediation Script
# Description: Ensure 18.9.35.2 fAllowToGetHelp is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.35.2.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.35.2: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
