# ==============================================================
# CIS Check: 18.10.26.4.1 (L1) - Remediation Script
# Description: Ensure 'System: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled'
# GPO Path: Computer Configuration > Administrative Templates > Windows Components > Event Log Service > System > Control Event Log behavior when the log file reaches its maximum size
# Registry Path: HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\System\Retention
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_system_eventlog_retention.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.26.4.1: Ensure 'System Log Retention' is Disabled"
Write-Host "=============================================================="

Add-Content -Path $LogFile -Value "`n=============================================================="
Add-Content -Path $LogFile -Value $StartMsg

function Get-SystemEventLogRetentionValue {
    try {
...
$CurrentValue = Get-SystemEventLogRetentionValue
