...
# Description: Set 'Control whether exclusions are visible to local users' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_hide_exclusions.log"
...
Write-Host "Hiding exclusions from local users (Registry: 1)"
Write-Host "=============================================================="
