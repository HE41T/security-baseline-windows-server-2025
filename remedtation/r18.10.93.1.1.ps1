...
# Description: Set 'No auto-restart with logged on users' to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_wu_autorestart.log"
...
Write-Host "Enabling Auto-Restart after updates (Registry: 0)"
Write-Host "=============================================================="
