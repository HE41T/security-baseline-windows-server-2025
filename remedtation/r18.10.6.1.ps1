# ==============================================================
# CIS Check: 18.10.6.1 (L1) - Remediation Script
# Description: Ensure 18.10.6.1 MSAOptional is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.10.6.1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.6.1: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
