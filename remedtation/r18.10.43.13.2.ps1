# ==============================================================
# CIS Check: 18.10.43.13.2 (L1) - Remediation Script
# Description: Set 'Scan packed executables' to 'Enabled' (Registry: 0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_packed_exe_scan.log"
...
Write-Host "Enabling Packed Executable Scanning (Registry: 0)"
Write-Host "=============================================================="
