# ==============================================================
# CIS Check: 18.10.26.3.2 (L1) - Remediation Script
# Description: Ensure 'Setup: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater'
# GPO Path: Computer Configuration > Administrative Templates > Windows Components > Event Log Service > Setup > Specify the maximum log file size (KB)
# Registry Path: HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\Setup\MaxSize
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_setup_eventlog_maxsize.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.26.3.2: Ensure 'Setup Log MaxSize' is >= $DesiredValue KB"
Write-Host "=============================================================="

Add-Content -Path $LogFile -Value "`n=============================================================="
Add-Content -Path $LogFile -Value $StartMsg

function Get-SetupEventLogMaxSizeValue {
    try {
...
$CurrentValue = Get-SetupEventLogMaxSizeValue
