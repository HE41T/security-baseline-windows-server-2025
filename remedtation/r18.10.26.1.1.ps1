...
# GPO Path: Computer Configuration > Administrative Templates > Windows Components > Event Log Service > Application > Control Event Log behavior when the log file reaches its maximum size
# Registry Path: HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\Application\Retention
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_application_eventlog_retention.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.26.1.1: Ensure 'Application Log Retention' is Disabled"
Write-Host "=============================================================="

Add-Content -Path $LogFile -Value "`n=============================================================="
Add-Content -Path $LogFile -Value $StartMsg

function Get-EventLogRetentionValue {
    try {
...
$CurrentValue = Get-EventLogRetentionValue
