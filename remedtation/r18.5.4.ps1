# ==============================================================
# CIS Check: 18.5.4 (L1) - Remediation Script
# Description: Ensure 18.5.4 EnableICMPRedirect is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.5.4.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.5.4: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
