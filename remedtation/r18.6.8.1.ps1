# ==============================================================
# CIS Check: 18.6.8.1 (L1) - Remediation Script
# Description: Ensure 18.6.8.1 AuditInsecureGuestLogon is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.8.1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.8.1: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
