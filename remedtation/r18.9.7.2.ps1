# ==============================================================
# CIS Check: 18.9.7.2 (L1) - Remediation Script
# Description: Ensure 18.9.7.2 PreventDeviceMetadataFromNetwork is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.7.2.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 1
$RegPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Device Metadata"
$RegName = "PreventDeviceMetadataFromNetwork"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.7.2: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
