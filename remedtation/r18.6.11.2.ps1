# ==============================================================
# CIS Check: 18.6.11.2 (L1) - Remediation Script
# Description: Ensure 18.6.11.2 NC_AllowNetBridge_NLA is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.11.2.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 0
$RegPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Network Connections"
$RegName = "NC_AllowNetBridge_NLA"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.11.2: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
