...
$LogFile = "C:\Windows\Temp\remediate_18_10_57_3_9_5.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.57.3.9.5: Ensure 'Set client connection encryption level' is set to 'Enabled: High Level' (Automated)"
Write-Host "=============================================================="
