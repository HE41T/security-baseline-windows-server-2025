# ==============================================================
# CIS Check: 18.6.7.3 (L1) - Remediation Script
# Description: Ensure 18.6.7.3 AuditInsecureGuestLogon is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.7.3.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.7.3: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
