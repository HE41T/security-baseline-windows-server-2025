# ==============================================================
# CIS Check: 18.9.28.7 (L1) - Remediation Script
# Description: Ensure 18.9.28.7 AllowDomainPINLogon is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.28.7.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.28.7: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
