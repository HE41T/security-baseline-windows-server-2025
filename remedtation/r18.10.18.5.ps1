# ==============================================================
# CIS Check: 18.10.18.5 (L1) - Remediation Script
...
$LogFile = "C:\Windows\Temp\remediate_18_10_18_5.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.18.5: Ensure 'Enable App Installer ms-appinstaller protocol' is set to 'Disabled' (Automated)"
Write-Host "=============================================================="
