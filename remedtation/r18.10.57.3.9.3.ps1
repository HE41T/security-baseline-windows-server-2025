# ==============================================================
# CIS Check: 18.10.57.3.9.3 (L1) - Remediation Script
# Description: Set 'Require use of specific security layer for remote (RDP) connections' to 'Enabled: SSL' (2)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_rdp_security_layer.log"
...
Write-Host "Enforcing SSL/TLS Security Layer for RDP (Registry: 2)"
Write-Host "=============================================================="
