# ==============================================================
# CIS Check: 17.8.1 (L1) - Remediation Script
# Description: Audit Sensitive Privilege Use
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_17_8_1.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 17.8.1: Audit Sensitive Privilege Use"
Write-Host "=============================================================="
...
$Subcat = "Sensitive Privilege Use"
try {
