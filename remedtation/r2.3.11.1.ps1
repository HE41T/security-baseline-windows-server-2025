# ==============================================================
# CIS Check: 2.3.11.1 (L1) - Remediation Script
# Description: Allow Local System to use computer identity for NTLM
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_2_3_11_1.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 2.3.11.1: Allow Local System to use computer identity for NTLM"
Write-Host "=============================================================="
