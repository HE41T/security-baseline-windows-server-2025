# ==============================================================
# CIS Check: 18.9.3.1 (L1) - Remediation Script
# Description: Ensure 18.9.3.1 ProcessCreationIncludeCmdLine_Enabled is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.3.1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.3.1: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
