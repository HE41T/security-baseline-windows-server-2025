# ==============================================================
# CIS Check: 18.10.89.1.1 (L1) - Remediation Script
# Description: Set 'Allow Basic authentication' for WinRM Client to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_winrm_client_auth.log"
...
Write-Host "Disabling WinRM Client Basic Authentication (Registry: 0)"
Write-Host "=============================================================="
