# ==============================================================
# CIS Check: 18.10.8.3 (L1) - Remediation Script
# Description: Ensure 18.10.8.3 NoDriveTypeAutoRun is set to 255
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.10.8.3.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.8.3: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
