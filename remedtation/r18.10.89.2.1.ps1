# ==============================================================
# CIS Check: 18.10.89.2.1 (L1) - Remediation Script
# Description: Set 'Allow Basic authentication' for WinRM Service to 'Disabled' (0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_winrm_service_auth.log"
...
Write-Host "Disabling WinRM Service Basic Authentication (Registry: 0)"
Write-Host "=============================================================="
