...
# Description: Set 'Manage preview builds' to 'Disabled' (Registry: 1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_preview_builds.log"
...
Write-Host "Disabling Preview Builds (Registry: 1)"
Write-Host "=============================================================="
