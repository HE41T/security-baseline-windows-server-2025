# ==============================================================
# CIS Check: 18.10.42.1 (L1) - Remediation Script
...
$LogFile = "C:\Windows\Temp\remediate_ms_account_block.log"
...
function Get-MSAccountBlockValue {
    ...
    $LgpoContent = @"
Computer
SOFTWARE\Policies\Microsoft\Windows\Messenger\Client
MicrosoftAccountConsumerAuthentication
DWORD:0
"@
...
if ($CurrentValue -eq -1 -or $CurrentValue -ne $DesiredValue) {
    $Msg = "Value is incorrect or missing. Fixing to $DesiredValue (Blocked)..."
...
"@
    ...
    $Msg = "Value is already set to Blocked ($CurrentValue). No action required."
