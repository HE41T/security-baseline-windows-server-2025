# ==============================================================
# CIS Check: 18.7.12 (L1) - Remediation Script
# Description: Ensure 18.7.12 NoWarningNoElevationOnInstall is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.7.12.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.7.12: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
