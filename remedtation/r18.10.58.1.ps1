# ==============================================================
# CIS Check: 18.10.58.1 (L1) - Remediation Script
# Description: Set 'Prevent downloading of enclosures' to 'Enabled' (1)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_rss_download_restriction.log"
...
Write-Host "Disabling RSS enclosure downloads (Registry: 1)"
Write-Host "=============================================================="
