# ==============================================================
# CIS Check: 18.6.8.4 (L1) - Remediation Script
# Description: Ensure 18.6.8.4 AllowInsecureGuestAuth is set to 0
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.8.4.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.8.4: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
