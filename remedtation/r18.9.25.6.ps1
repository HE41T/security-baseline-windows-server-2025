# ==============================================================
# CIS Check: 18.9.25.6 (L1) - Remediation Script
# Description: Ensure 18.9.25.6 PasswordAgeDays is set to 30
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.25.6.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 30
$RegPath = "HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd"
$RegName = "PasswordAgeDays"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.25.6: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
