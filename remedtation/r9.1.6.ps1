# ==============================================================
# CIS Check: 9.1.6 (L1) - Remediation Script
# Description: FW Domain: Log Dropped Packets (Registry & Cmdlet)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_9_1_6.log"
...
try {
    ...
    Set-NetFirewallProfile -Profile Domain -LogBlocked True -ErrorAction SilentlyContinue
