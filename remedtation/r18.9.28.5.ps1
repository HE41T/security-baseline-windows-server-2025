# ==============================================================
# CIS Check: 18.9.28.5 (L1) - Remediation Script
# Description: Ensure 18.9.28.5 DisableLockScreenAppNotifications is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.28.5.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 1
$RegPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"
$RegName = "DisableLockScreenAppNotifications"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.28.5: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
