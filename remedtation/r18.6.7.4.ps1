# ==============================================================
# CIS Check: 18.6.7.4 (L1) - Remediation Script
# Description: Ensure 18.6.7.4 EnableAuthRateLimiter is set to 1
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.6.7.4.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 1
$RegPath = "HKLM:\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters"
$RegName = "EnableAuthRateLimiter"

$StartMsg = "Remediation started: $Date"
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.6.7.4: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
