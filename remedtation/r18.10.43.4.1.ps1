...
# Description: Ensure 'Enable EDR in block mode' is set to 'Enabled' (Automated)
# Registry Path: HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Features
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18_10_43_4_1.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.10.43.4.1: Ensure 'Enable EDR in block mode' is set to 'Enabled' (Automated)"
Write-Host "=============================================================="
