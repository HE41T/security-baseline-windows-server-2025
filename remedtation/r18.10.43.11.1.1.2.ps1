...
# Description: Set Brute-Force Protection to 'Enabled: Audit' (2)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_brute_force_protection.log"
$Date = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
$DesiredValue = 2 # ตั้งเป็น Audit ตามคำแนะนำพื้นฐาน
...
Write-Host "Setting Brute-Force Protection to Enabled: Audit (2)"
Write-Host "=============================================================="
