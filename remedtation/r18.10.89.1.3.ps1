# ==============================================================
# CIS Check: 18.10.89.1.3 (L1) - Remediation Script
# Description: Set 'Disallow Digest authentication' for WinRM Client to 'Enabled' (Registry: 0)
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_winrm_digest_auth.log"
...
Write-Host "Disabling WinRM Client Digest Authentication (Registry: 0)"
Write-Host "=============================================================="
