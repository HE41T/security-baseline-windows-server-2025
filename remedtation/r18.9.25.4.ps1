# ==============================================================
# CIS Check: 18.9.25.4 (L1) - Remediation Script
# Description: Ensure 18.9.25.4 PasswordComplexity is set to 4
# ==============================================================

$LogFile = "C:\Windows\Temp\remediate_18.9.25.4.log"
...
Write-Host "=============================================================="
Write-Host $StartMsg
Write-Host "Control 18.9.25.4: Set $RegName to $DesiredValue"
Write-Host "=============================================================="
